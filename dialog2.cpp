...
{
    ui->setupUi(this);
    QPixmap pix("C:/Users/a/Desktop/New folder (6)/ad12");
...
void Dialog2::on_Size1_toggled(bool checked)
{
    if (checked){
...
void Dialog2::on_BuyButton_clicked()
{
    QMessageBox::about(this,"","The purchase was made");
    close();
}

void Dialog2::on_Size2_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
...
void Dialog2::on_Size3_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
...
void Dialog2::on_Size4_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
...
void Dialog2::on_Size5_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
...
void Dialog2::on_Size6_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
...
void Dialog2::on_Size7_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
...
void Dialog2::on_Size8_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
...
void Dialog2::on_Size9_toggled(bool checked)
{
    if (checked){
        ui->BuyButton->setDisabled(false);
        ui->Size1->setDisabled(true);
